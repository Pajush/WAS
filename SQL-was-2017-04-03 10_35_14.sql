...
CREATE TABLE IF NOT EXISTS `tag` (
  ...
  `name` varchar(50) COLLATE utf8_czech_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci ROW_FORMAT=COMPACT COMMENT='Tagy příspěvku';
...
CREATE TABLE IF NOT EXISTS `type` (
  ...
  `name` varchar(50) COLLATE utf8_czech_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_czech_ci COMMENT='Typ příspěvku';

-- Exportování dat pro tabulku was.type: ~0 rows (přibližně)
DELETE FROM `type`;
